...
namespace Xp_Sgpi.Application.DTOs.Order
{
    public class OrderDto
    {
        ...
        /// </summary>
        [RegularExpression("^(Approved|Rejected|Pending|Partial)$", ErrorMessage = "O valor deve ser Approved, Rejected, Pending ou Partial.")]
