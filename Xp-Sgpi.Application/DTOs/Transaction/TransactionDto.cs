...
namespace Xp_Sgpi.Application.DTOs.Transaction
{
    public class TransactionDto
    {
        ...
        /// <summary>
        /// O valor deve ser Stock ou Account.
        /// </summary>
        ...
        [RegularExpression("^(Sell|Buy|Withdraw|Deposit)$", ErrorMessage = "O valor deve ser Sell, Buy, Withdraw ou Deposit.")]
